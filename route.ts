 ...
 * @type {string[]}
 */
export const publicRoutes = ["/favicon.ico", "/", "/auth/login", "/auth/register", "/auth/verify-email/:token", "/auth/forgot-password", "/auth/reset-password/:token", "/home", "/service", "/service/:name/:productId", "/cart"];
